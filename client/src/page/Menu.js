...
const Menu = () => {
  ...
  if (!productDisplay) {
    return <p className="text-center">Product not found or data is loading...</p>;
  }
  ...
  return (
    <div className="p-2 md:p-4">
      <div className="w-full max-w-4xl m-auto md:flex bg-white">
        ...
        <img
            src={productDisplay.image || "data:image/png;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAEBAQEBAQEBAQEB…"}
